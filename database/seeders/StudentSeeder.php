...
class StudentSeeder extends Seeder
{
    public $data = [
        ...
        [
            "student_id" => 1669031424299,
            "first_name" => "Jackson",
            "last_name" => "Gould",
            "email" => "lorem@orci.com"
        ],
        [
            "student_id"=> 1610122466699,
            "first_name"=> "Amena",
            "last_name"=> "Winters",
            "email"=> "eu.lacus@Uttincidunt.org"
        ],
        [
            "student_id"=> 1660020239499,
            "first_name"=> "Giacomo",
            "last_name"=> "James",
            "email"=> "Duis.mi.enim@mi.com"
        ],
        [
            "student_id"=> 1664110352499,
            "first_name"=> "Nathan",
            "last_name"=> "Moran",
            "email"=> "eget.lacus@erosNam.net"
        ],
        [
            "student_id"=> 1683092555899,
            "first_name"=> "Vivian",
            "last_name"=> "Workman",
            "email"=> "fringilla@sagittis.net"
        ],
        [
            "student_id"=> 1607102510699,
            "first_name"=> "Amal",
            "last_name"=> "Cervantes",
            "email"=> "aliquet@in.co.uk"
        ],
        [
            "student_id"=> 1656061966999,
            "first_name"=> "Octavius",
            "last_name"=> "Wade",
            "email"=> "pede@mus.ca"
        ],
        [
            "student_id"=> 1667081298699,
            "first_name"=> "Kenneth",
            "last_name"=> "Fletcher",
            "email"=> "in.consequat@dignissimtemporarcu.org"
        ],
        [
            "student_id"=> 1697062419499,
            "first_name"=> "Malik",
            "last_name"=> "Silva",
            "email"=> "Suspendisse@commodo.com"
        ],
        [
            "student_id"=> 1656081805699,
            "first_name"=> "Xanthus",
            "last_name"=> "Mcgowan",
        ...
        [
            ...
            "student_id"=> 1611112931699,
            "first_name"=> "Jennifer",
            "last_name"=> "Stevenson",
            "email"=> "sollicitudin.adipiscing@enean.com"
        ],
        [

            "student_id"=> 1688110873699,
            "first_name"=> "Brent",
            "last_name"=> "Mcneil",
